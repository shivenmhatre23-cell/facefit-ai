...
import { Scissors, X, Copy, Check, Sparkles } from 'lucide-react';
...
export function BarberInstructionModal({ hairstyle, onClose }: BarberInstructionModalProps) {
  ...
  const { barberInstructions } = hairstyle;

  const handleCopy = () => {
    const text = `FACFIT AI - BARBER CONSULTATION CARD
Cut: ${hairstyle.name}
Fade/Taper: ${barberInstructions.fadeOrTaperType}
Sides & Back: ${barberInstructions.sidesAndBack}
Top Length & Cut: ${barberInstructions.topLength}
Styling Finish: ${barberInstructions.stylingFinish}
Styling Products: ${hairstyle.suitableProducts.join(', ')}`;
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs animate-fadeIn">
      <div className="relative w-full max-w-lg bg-white rounded-2xl border border-neutral-200 shadow-2xl p-6 sm:p-8 animate-scaleUp">
        {/* Close Button */}
        <button
          onClick={onClose}
        ...
        <div className="space-y-3.5 mb-6 text-xs">
          <div className="p-3.5 rounded-xl bg-neutral-50 border border-neutral-200/80">
            ...
            <p className="font-semibold text-neutral-900 leading-relaxed">
              {barberInstructions.sidesAndBack}
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div className="p-3 rounded-xl bg-neutral-50 border border-neutral-200/80">
              ...
              <p className="font-medium text-neutral-800">
                {barberInstructions.fadeOrTaperType}
              </p>
            </div>
            ...
            <div className="p-3 rounded-xl bg-neutral-50 border border-neutral-200/80">
              ...
              <p className="font-medium text-neutral-800">
                {barberInstructions.stylingFinish}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mb-6 pt-3 border-t border-neutral-100">
          ...
          <div className="flex flex-wrap gap-2">
            {hairstyle.suitableProducts.map((p, i) => (
              <span
                key={i}
